            ...
            # TODO: Add eatrate; make this useful
                ...
                if settings['save_data']:
                    if settings['energy_model']:
                        ...
                        save_sim(folder, isings_copy, fitness_stat, mutationrate, fitC, fitm, rep, settings)
                    else:
                        save_sim(folder, isings, fitness_stat, mutationrate, fitC, fitm, rep, settings)
...
def save_sim(folder, isings, fitness_stat, mutationrate, fitC, fitm, gen, settings):

    rep = settings['curr_repeat']
    filenameI = folder + 'isings/gen[' + str(rep) + ']-isings.pickle'
    filenameS = folder + 'stats/gen[' + str(rep) + ']-stats.pickle'
