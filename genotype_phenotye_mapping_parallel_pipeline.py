...
if __name__=='__main__':
    ...
    pipeline_settings['add_save_file_name'] = 'rerun_small_test' #'resulotion_80_hugeres_3_repeats_gen_100' # 'resulotion_80_hugeres_3_repeats_last_gen'
