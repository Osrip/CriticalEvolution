...
def create_settings():
    ...
    # Speciation stuff
    settings['speciation'] = True
    #Constants for delta formula c_top, c_weight, c_beta
    settings['shared_fitness_constants'] = (1, 1, 1)
    settings['delta_threshold_speciation'] = 2
    settings['continuous_species'] = True
...
def main_hyperparams(iterations):
    ray.init()
    hyperparam_configs = [generate_hyperparams() for _ in range(20)]
