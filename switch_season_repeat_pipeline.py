...
def main(num_repeats, same_repeats, food_summer, food_winter, folder_add, only_fittest):

    folder_add = 'num_rep_{}_same_rep_{}_f_sum_{}_f_win{}_{}'.format(num_repeats, same_repeats, food_summer, food_winter
                                                                     , folder_add)

    run_combis, first_subfolder = run_all_combinations(num_repeats, same_repeats, food_summer, food_winter, folder_add, only_fittest)
    plot_pipeline(run_combis, first_subfolder, 'avg_energy')


def run_all_combinations(num_repeats, same_repeats, food_summer, food_winter, folder_add, only_fittest):
    '''
...
if __name__ == '__main__':
    ...
    '''
    folder_add = 'huge_run_20_win_food'
    num_repeats = 200
    same_repeats = 4
    food_summer = 100
    food_winter = 20
    ...
    main(num_repeats, same_repeats, food_summer, food_winter, folder_add, only_fittest)
