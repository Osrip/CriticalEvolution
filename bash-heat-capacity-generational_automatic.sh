...
parallel --bar --eta -j5 "python3 compute-heat-capacity-generational-2 ${sim} {1} {2}" ::: $(seq 101) ::: $2
#eval 'parallel --bar --eta -j5 "python3 compute-heat-capacity-generational-2 $sim {1} {2}" ::: $(seq 101) ::: {generations}'
