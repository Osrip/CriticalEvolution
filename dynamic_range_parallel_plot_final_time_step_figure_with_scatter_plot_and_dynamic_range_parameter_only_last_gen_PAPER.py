...
def dynamic_range_parameter_plot(sim_data_list_each_folder, plot_settings):
    ...
    legend_elements = [
        ...
        Line2D([0], [0], marker=plot_settings['marker2']['critical'][0], color='w', label=r'$\beta_\mathrm{init}=1$', markerfacecolor='grey',
               markersize=25, alpha=0.75),
        Line2D([0], [0], marker=plot_settings['marker2']['sub_critical'][0], color='w', label=r'$\beta_\mathrm{init}=10$', markerfacecolor='grey',
               markersize=25, alpha=0.75),
    ]
    # Line2D([0], [0], color='b', lw=4, c='grey', linestyle='dashed', alpha=0.7,
...
if __name__ == '__main__':
    ...
    plot_settings['marker2'] = {'critical': ['^'], #6
                               'sub_critical': ['o'],
                               'super_critical': []}
